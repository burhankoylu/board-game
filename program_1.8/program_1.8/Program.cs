...
namespace program_1._8
{
    internal class Program
    {
        static void Main(string[] args)
        {
                ...
                if (round == 1)
                {
                    ...
                    while (move_controller)
                    {
                        try
                        {
                            ...
                            if (b1 < 1 || b1 > 9 || b1 == a1 || b1 == a2 || b1 == a3)
                            {
                                Console.WriteLine();
                                Console.WriteLine("Please enter a number between 1 to 9");
                            }
                    ...
                    while (move_controller)
                    {
                        try
                        {
                            ...
                            if (b2 < 1 || b2 > 9 || b2 == a1 || b2 == a2 || b2 == a3 || b2 == b1)
                            {
                                Console.WriteLine();
                                Console.WriteLine("Please enter a number between 1 to 9");
                            }
                    ...
                    while (move_controller)
                    {
                        try
                        {
                            ...
                            if (b3 < 1 || b3 > 9 || b3 == a1 || b3 == a2 || b3 == a3 || b3 == b1 || b3 == b2)
                            {
                                Console.WriteLine();
                                Console.WriteLine("Please enter a number between 1 to 9");
                            }
                    ...
                    while (move_controller)
                    {
                        try
                        {
                            ...
                            if (c1 < 1 || c1 > 9 || c1 == a1 || c1 == a2 || c1 == a3 || c1 == b1 || c1 == b2 || c1 == b3)
                            {
                                Console.WriteLine();
                                Console.WriteLine("Please enter a number between 1 to 9");
                            }
                    ...
                    while (move_controller)
                    {
                        try
                        {
                            ...
                            if (c2 < 1 || c2 > 9 || c2 == a1 || c2 == a2 || c2 == a3 || c2 == b1 || c2 == b2 || c2 == b3 || c2 == c1)
                            {
                                Console.WriteLine();
                                Console.WriteLine("Please enter a number between 1 to 9");
                            }
                    ...
                    while (move_controller)
                    {
                        try
                        {
                            ...
                            if (c3 < 1 || c3 > 9 || c3 == a1 || c3 == a2 || c3 == a3 || c3 == b1 || c3 == b2 || c3 == b3 || c3 == c1 || c3 == c2)
                            {
                                Console.WriteLine();
                                Console.WriteLine("Please enter a number between 1 to 9");
                            }
            ...
            {
                Console.WriteLine();
                Console.Write("Winner: Player");
            }

            else
            {
                Console.WriteLine();
                Console.Write("Winner: Computer");
            }
            Console.ReadLine();
        }
    }
